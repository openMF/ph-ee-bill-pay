...
public class BillPayDTOConstant {

    public static final String requestId = "requestId";
    public static final String billInquiryRequestId = "billInquiryRequestId";
    public static final String billId = "billId";
    public static final String paymentRefereneID = "paymentRefereneID";
    public static final String clientCorrelationId = "clientCorrelationId";
    public static final String billID = "billID";
