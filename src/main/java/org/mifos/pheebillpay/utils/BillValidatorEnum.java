...
public enum BillValidatorEnum implements ValidationCodeType {
    ...
    BILL_SCHEMA_VALIDATION_ERROR("error.msg.schema.validation.errors", "The request is invalid"), INVALID_BILL_ID(
            "error.msg.schema.bill.id.cannot.be.null.or.empty",
            "Bill ID cannot be null or empty"), INVALID_BILL_ID_LENGTH("error.msg.schema.bill.id.length.is.invalid",
                    "Bill ID length is invalid"), INVALID_REQUEST_TYPE("error.msg.schema.request.type.cannot.be.null.or.empty",
                            "Request Type cannot be null or empty"), INVALID_REQUEST_TYPE_VALUE("error.msg.schema.request.type.is.invalid",
                                    "Request Type is Invalid"), INVALID_PAYER_FSP_ID(
                                            ...
                                            "Payer Fsp Id cannot be null or empty"), INVALID_FINANCIAL_ADDRESS(
                                                    ...
                                                    "Financial Address cannot be null or empty"), INVALID_PAYER_FSP_DETAILS(
                                                            ...
                                                            "Payer Fsp details cannot be null or empty"), INVALID_ALIAS_ID(
